...
namespace PPTVForWin8.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        protected virtual void CoreDispatcher_AcceleratorKeyActivated(CoreDispatcher sender,
            AcceleratorKeyEventArgs args)
        {
            ...
            if ((args.EventType == CoreAcceleratorKeyEventType.SystemKeyDown ||
                ...
                (int)virtualKey == 166 || (int)virtualKey == 167 || virtualKey == VirtualKey.Back || virtualKey == VirtualKey.Escape))
            {
                ...
                if (((int)virtualKey == 166 && noModifiers) ||
                    ...
                    (virtualKey == VirtualKey.Back && onlyAlt) || 
        ...
        /// <param name="sender">Instance that triggered the event.</param>
        /// <param name="args">Event data describing the conditions that led to the event.</param>
        protected virtual void CoreWindow_PointerPressed(CoreWindow sender,
