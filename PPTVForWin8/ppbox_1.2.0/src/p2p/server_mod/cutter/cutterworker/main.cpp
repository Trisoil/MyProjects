...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	printf("ver.3.9a released by Tady, 05232012\n");
	printf("\n");
...
//	std::string strArg1("http://192.168.222.94/channels/cctv2/flv.head"), strArg2;
	...
	CStreamReader reader(strArg1, strArg2, 2, cut_with_kf, interval, piece_life_span, head_piece_life_span, need_modify_ts);
