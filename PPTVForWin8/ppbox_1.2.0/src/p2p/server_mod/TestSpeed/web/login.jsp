...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top">
	  ...
	  <p class="font04">&nbsp;</p>
	  <p class="font04">&nbsp;</p>
	  <p class="font04"><span class="STYLE2">PPLive 测速后台管理系统</span><b><br>
      </b></p>
          ...
          <td align="center" bgcolor="#FFFFFF"><table width="300"  border="0" cellspacing="1" cellpadding="2">
            <form name="form1" method="post" action="logindo.jsp">
              ...
              <tr>
                ...
                <td nowrap><input name="username" type="text" id="username" value="admin" size="30" maxlength="20"></td>
              </tr>
              <tr>
                <td width="91" nowrap><span class="STYLE3">请输入管理口令:</span></td>
                <td width="198" nowrap><input name="password" type="password" id="password" value="admin2006" size="30" maxlength="20"></td>
              </tr>
              <tr>
                <td nowrap>&nbsp;</td>
