...
public class IPSeeker {
	...
	private static final String IPDATE_FILE_PATH = Constant.ROOTPATH + "/WEB-INF/";

	private static final String IPDATE_FILE = "ipdata.Dat";
	//private static final String IPDATE_FILE = "d:/ipdat.dat";
	//private static final String IPDATE_FILE = "d:/QQWry.Dat";
	...
	public IPSeeker() {
        ...
        try {
            ...
            String FILE_PATH=cpr.getPath();
            // ClassPathResource cpr = new ClassPathResource("/" + IPDATE_FILE);
			// System.out.println(cpr.getFile());
            String root = my.mysystem.tool.ContextUtil.rootPath;
            System.out.println("loading ip info: " + root  + "WEB-INF/" + IPDATE_FILE);
			ipFile = new RandomAccessFile(root + "WEB-INF/" + IPDATE_FILE, "r");
     ...
     * 
     * @author Jiang qunfeng
     * Create Date: 2009-12-24 
     * Modified By:                                         
     * Modified Date: 
     * 
     * @param   String 字符串形式的IP地址
     */
	...
	public static void main(String[] args) {
		System.out.println(long2IP(Long.valueOf("3730046910")));
		 System.out.println(ip2Long("112.91.113.214"));
		 
		System.out.println(new IPSeeker().getCountry("109.246.225.218"));
		 
		 //System.out.println(long2IP(973996032));
	}
}
