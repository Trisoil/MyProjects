...
namespace storage
{
    struct IUploadListener
    {
        ...
        virtual void OnAsyncGetBlockSucced(const RID& rid, boost::uint32_t block_index, base::AppBuffer const & buffer) = 0;
        virtual void OnAsyncGetBlockFailed(const RID& rid, boost::uint32_t block_index, int failed_code) = 0;
    ...
    struct IInstanceListener
    {
        ...
        virtual void OnMakeBlockSucced(boost::uint32_t block_info);
        virtual void OnMakeBlockFailed(boost::uint32_t block_info);
    ...
    struct IDownloadDriver
    {
        ...
        virtual void OnNoticeMakeBlockSucced(boost::uint32_t block_info) = 0;

        virtual void OnNoticeMakeBlockFailed(boost::uint32_t block_info) = 0;

        virtual void OnNoticeGetFileName(const string& file_name) = 0;

        virtual void OnNoticeFileDownloadComplete() = 0;

        virtual void OnRecvSubPiece(boost::uint32_t position, const protocol::SubPieceBuffer& buffer) = 0;
    ...
    struct IInstance
    {
        ...
        virtual void AsyncGetBlock(boost::uint32_t block_index, IUploadListener::p listener) = 0;
        ...
        // virtual void AsyncGetSubPieceForPlay(boost::uint32_t start_postion, boost::uint32_t max_count, IPlayerListener::p listener) = 0;
        // virtual void AsyncGetSubPieceForPlay(boost::uint32_t start_postion, IPlayerListener::p listener) = 0;
        // virtual void AsyncGetSubPieceForPlay(const protocol::SubPieceInfo& subpiece_info, IPlayerListener::p listener) = 0;
        virtual bool GetSubPieceForPlay(boost::uint32_t start_postion, std::vector<SubPieceBuffer> & buffers) = 0;
        virtual bool HasPiece(const protocol::PieceInfo& piece_info) = 0;
        virtual bool HasPiece(boost::uint32_t start_postion) = 0;
        ...
        virtual bool GetNextPieceForDownload(boost::uint32_t start_position, protocol::PieceInfoEx& piece_for_download) = 0;
        ...
        virtual bool GetNextSubPieceForDownload(boost::uint32_t start_position, protocol::SubPieceInfo& subpiece_for_download) = 0;
        ...
        virtual void SetFileLength(boost::uint32_t file_length) = 0;
        virtual boost::uint32_t GetFileLength() = 0;
        virtual boost::uint32_t GetDownloadBytes() = 0;
        virtual boost::uint32_t GetBlockSize() = 0;
        virtual boost::uint32_t GetBlockCount() = 0;
        ...
        virtual void WeUploadSubPiece(boost::uint32_t num) = 0;

        virtual float GetInstanceValue() = 0;
        virtual boost::uint32_t GetDownloadedBlockCount() const = 0;

        virtual void GetBlockPosition(boost::uint32_t block_index, boost::uint32_t &offset, boost::uint32_t &length) = 0;
        virtual void GetSubPiecePosition(const protocol::SubPieceInfo &subpiec_info, boost::uint32_t &offset, boost::uint32_t &length) = 0;
    ...
    struct IStorage
    {
        ...
        virtual void GetVodResources(std::set<RID>& rid_s, boost::uint32_t mod_number, boost::uint32_t group_count) = 0;
        virtual void GetLiveResources(std::set<RID>& rid_s, boost::uint32_t mod_number, boost::uint32_t group_count) = 0;
        // 删除url_info所对应的信息
