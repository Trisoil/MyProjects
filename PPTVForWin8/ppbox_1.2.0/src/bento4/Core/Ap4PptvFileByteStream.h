...
#ifndef _AP4_PPTV_FILE_BYTE_STREAM_H_
#define _AP4_PPTV_FILE_BYTE_STREAM_H_


class AP4_PptvFileByteStream: public AP4_ByteStream
{
public:
    // types
    typedef enum {
     ...
     * it cannot
     */
    static AP4_Result Create(const char*      name,
                             Mode             mode,
    ...
    // constructors
    AP4_PptvFileByteStream(AP4_ByteStream* delegate) : m_Delegate(delegate) {}
    
#if !defined(AP4_CONFIG_NO_EXCEPTIONS)
    /**
     * @deprecated
     */
    AP4_PptvFileByteStream(const char*   name,
                           Mode          mode,
                           AP4_LargeSize position,
                           AP4_LargeSize segment_size);
#endif
...
protected:
    virtual ~AP4_PptvFileByteStream() {
        delete m_Delegate;
    }
...
#endif // _AP4_PPTV_FILE_BYTE_STREAM_H_
