...
public:
    ...
    virtual AP4_Result GetChunkForSample(AP4_Ordinal   sample,
                                         ...
                                         AP4_Ordinal&  sample_description_index);
    // Add
    virtual AP4_Result GetChunkSampleIndexs(AP4_Ordinal chunk_index,
    ...
    // ADD FOR PPBOX
    virtual AP4_Array<AP4_StscTableEntry> const & GetEntries(void);
    virtual void SetEntry(AP4_Ordinal index, AP4_StscTableEntry stsc);
    //virtual void SetLastItemChunkCount(AP4_Ordinal chunk_count);
