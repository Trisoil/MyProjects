...
#ifndef _TOOLS_STATUS_DATA_STRUCT_H_
#define _TOOLS_STATUS_DATA_STRUCT_H_
...
struct STASTISTIC_INFO
{
    ...
    boost::uint8_t Resersed[954];                       // 保留字段
};
...
struct PEER_UPLOAD_INFO
{
    boost::uint32_t ip;
    boost::uint16_t port;
    boost::uint16_t upload_speed;
    boost::uint8_t resersed[128];
...
#endif // _TOOLS_STATUS_DATA_STRUCT_H_
