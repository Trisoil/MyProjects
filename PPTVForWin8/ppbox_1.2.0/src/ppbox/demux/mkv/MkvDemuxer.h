...
#ifndef _PPBOX_DEMUX_MKV_MKV_DEMUXER_H_
#define _PPBOX_DEMUX_MKV_MKV_DEMUXER_H_

#include "ppbox/demux/base/Demuxer.h"
#include "ppbox/demux/mkv/MkvStream.h"
...
namespace ppbox
{
    namespace demux
    {
        ...
        PPBOX_REGISTER_DEMUXER("mkv", MkvDemuxer);

    } // namespace demux
} // namespace ppbox

#endif // _PPBOX_DEMUX_MKV_MKV_DEMUXER_H_
