...
#ifndef _LIVE_P2PCOMMON2_NEW_FRAMEWORK_SOCKET_H_
#define _LIVE_P2PCOMMON2_NEW_FRAMEWORK_SOCKET_H_

/* 
包含p2p模块中跟socket相关的定义
如果使用ten.dll，包含synacast/net目录下的文件
如果使用asio，包含synacast/asio
如果使用mfc，可以包含synacast/mfcnet.h和ppl/mswin/mfc/net.h
*/
...
#include <synacast/net/socket.h>


#else

#error "invalid platform for socket.h"
