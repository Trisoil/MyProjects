#ifndef _LIVE_P2PCOMMON2_NEW_SOURCEREADERLIB_SDPPLIN_H_
#define _LIVE_P2PCOMMON2_NEW_SOURCEREADERLIB_SDPPLIN_H_
...
// char *b64_decode(const char *in, char *out, int *size);
