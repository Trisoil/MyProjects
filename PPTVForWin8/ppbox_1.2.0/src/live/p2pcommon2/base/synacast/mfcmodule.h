...
#ifndef _LIVE_P2PCOMMON2_BASE_SYNACAST_MFCMODULE_H_
#define _LIVE_P2PCOMMON2_BASE_SYNACAST_MFCMODULE_H_
...
#define LOG(type, level, msg) PPL_LOG_IMPL(type, level, msg)
...
inline void CORE_SetLogLevel(int level)
{
}

inline void CORE_LogOn(int type)
{
}

inline void CORE_LogOff(int type)
{
}
/*
inline bool NET_UDP_SendTo(int sockHandle, const void *lpBuf, int nBufLen, LPSOCKADDR pSockAddr)
{
	return false;
}
...
typedef void* HOBJ;
inline int CORE_SendObjectMessage( HOBJ Target_obj, HOBJ Sender_obj, UINT Msg, UINT PARAM_1, UINT PARAM_2, UINT PARAM_3, UINT PARAM_4)
{
	return 0;
}
*/
