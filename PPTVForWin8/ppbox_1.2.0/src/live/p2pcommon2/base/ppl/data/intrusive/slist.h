...
#ifndef _LIVE_P2PCOMMON2_BASE_PPL_DATA_INTRUSIVE_SLIST_H_
#define _LIVE_P2PCOMMON2_BASE_PPL_DATA_INTRUSIVE_SLIST_H_
...
public:
	...
	slist_iterator_impl operator++(int) { slist_iterator_impl res = *this; this->inc(); return res; }
