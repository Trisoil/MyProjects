...
#ifndef _LIVE_P2PCOMMON2_BASE_PPL_DATA_NUMERIC_H_
#define _LIVE_P2PCOMMON2_BASE_PPL_DATA_NUMERIC_H_
...
template <>
struct numeric_traits<unsigned __int64>
{
...
*/
	...
	static string format(T val, const char* formatString)
	{
		...
		if ( len <= 0 || (size_t)len > max_buffer_size )
			return string();
...
{
public:
	typedef numeric_traits<ValueT> traits_type;
