...
#ifndef _LIVE_P2PCOMMON2_BASE_PPL_MSWIN_CRASH_H_
#define _LIVE_P2PCOMMON2_BASE_PPL_MAWIN_CRASH_H_
...
#include <ppl/mswin/file_finder.h>
...
private:
	...
	ppl::os::loadable_module m_dbghelp;
...
public:
	...
	{
		m_ExeFilename = ppl::os::module().get_file_path();

		ppl::os::module module;
		module.attach_to_self();
		tstring dllPath = module.get_file_directory();
		...
		tstring logfile = ppl::os::paths::combine(dllPath, _T("crash.log"));
