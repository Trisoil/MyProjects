...
namespace boost
{
  namespace system
  {
    ...
    template< class T >
    struct is_error_code_enum { BOOST_STATIC_CONSTANT(bool, value = false); };

    template< class T >
    struct is_error_condition_enum { BOOST_STATIC_CONSTANT(bool, value = false); };
...
#else
      template <class ConditionEnum>
      error_condition(ConditionEnum const & e)
      {
        *this = make_error_condition(e);
      }
#endif
...
#   include <boost/../boost_libs/system/src/error_code.cpp>
# endif
