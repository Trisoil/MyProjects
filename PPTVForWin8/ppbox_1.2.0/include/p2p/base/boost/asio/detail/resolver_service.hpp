...
// for stupid vc6, we changed the name 'resolver_service' to 
// 'thread_resolver_service' not to conflict with
// boost::asio::resolver_service

template <typename Protocol>
class thread_resolver_service
  : public boost::asio::detail::service_base<thread_resolver_service<Protocol> >
{
private:
...
public:
  ...
  // Constructor.
  thread_resolver_service(boost::asio::io_service& io_service)
    : boost::asio::detail::service_base<
        thread_resolver_service<Protocol> >(io_service),
      mutex_(),
