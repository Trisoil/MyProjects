<%@ WebHandler Language="C#" Class="live_parade_search_smart" %>
...
public class live_parade_search_smart : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ILiveSearch>.Invoke<string>(search, proxy => proxy.LiveParadeSearch(filter)));
    }
