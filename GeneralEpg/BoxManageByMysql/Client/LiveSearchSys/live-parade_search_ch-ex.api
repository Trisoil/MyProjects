<%@ WebHandler Language="C#" Class="live_parade_search_ch_ex" %>
...
public class live_parade_search_ch_ex : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ILiveSearch>.Invoke<string>(search, proxy => proxy.LiveParadeSearchChEx(filter)));
    }
