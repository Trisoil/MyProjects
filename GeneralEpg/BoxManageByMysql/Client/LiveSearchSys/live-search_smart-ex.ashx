<%@ WebHandler Language="C#" Class="live_search_smart_ex" %>
...
public class live_search_smart_ex : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ILiveSearch>.Invoke<string>(search, proxy => proxy.LiveSearchEx(filter)));
    }
