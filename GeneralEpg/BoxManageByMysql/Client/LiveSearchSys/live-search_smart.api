<%@ WebHandler Language="C#" Class="live_search_smart" %>
...
public class live_search_smart : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ILiveSearch>.Invoke<string>(search, proxy => proxy.LiveSearch(filter)));
    }
