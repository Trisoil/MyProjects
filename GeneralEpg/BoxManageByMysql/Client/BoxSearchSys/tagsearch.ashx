<%@ WebHandler Language="C#" Class="tagsearch" %>
...
public class tagsearch : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ITagSearch>.Invoke<string>(list, proxy => proxy.TagSearch(filter)));
    }
