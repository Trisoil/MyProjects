<%@ WebHandler Language="C#" Class="search_ch" %>
...
public class search_ch : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ISearch>.Invoke<string>(list, proxy => proxy.VideoSearchCH(filter)));
    }
