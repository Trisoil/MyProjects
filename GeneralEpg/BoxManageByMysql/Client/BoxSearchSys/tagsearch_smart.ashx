<%@ WebHandler Language="C#" Class="tagsearch_smart" %>
...
public class tagsearch_smart : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ITagSearch>.Invoke<string>(list, proxy => proxy.TagSearchSmart(filter)));
    }
