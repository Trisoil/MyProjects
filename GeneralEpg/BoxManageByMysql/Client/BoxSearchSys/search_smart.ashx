<%@ WebHandler Language="C#" Class="search_smart" %>
...
public class search_smart : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ISearch>.Invoke<string>(list, proxy => proxy.VideoSearchSmart(filter)));
    }
