<%@ WebHandler Language="C#" Class="search_smart_ex" %>
...
public class search_smart_ex : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ISearch>.Invoke<string>(list, proxy => proxy.VideoSearchSmartEx(filter)));
    }
