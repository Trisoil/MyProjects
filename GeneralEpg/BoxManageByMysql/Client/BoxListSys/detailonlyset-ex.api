<%@ WebHandler Language="C#" Class="detailonlyset_ex" %>
...
public class detailonlyset_ex : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<IDetails>.Invoke<string>(deta, proxy => proxy.DetailsOnlySetEx(filter)));
    }
