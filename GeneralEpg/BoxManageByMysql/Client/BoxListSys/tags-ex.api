<%@ WebHandler Language="C#" Class="tags_ex" %>
...
public class tags_ex : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(ServiceInvoke<ITags>.Invoke<string>(tag, proxy => proxy.TagsEx(filter)));
    }
