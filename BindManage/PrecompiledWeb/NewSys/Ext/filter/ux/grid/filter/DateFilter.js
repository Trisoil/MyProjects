Ext.ux.grid.filter.DateFilter = Ext.extend(Ext.ux.grid.filter.Filter, {
	...
	serialize: function(){
		...
		{
			args = [{type: 'date', comparison: 'gt', value: this.getFieldValue('on').format('yyyy-MM-dd 00:00:00')}];
			args.push({type: 'date', comparison: 'lt', value: this.getFieldValue('on').format('yyyy-MM-dd 23:59:59')});
