...
namespace Synacast.NHibernateActiveRecord.New
{
    ...
    public class SqlCount<T> : IActiveRecordQuery
    {
        ...
        public SqlCount(int start, int limit, string sort, string dir, string tableName, string primaryKey, string[][] filters, string otherWhere, params object[] otherParameters)
        {
            _start = start;
            _limit = limit;
            _sort = sort;
