...
namespace Synacast.NHibernateActiveRecord
{
    ...
    public class SqlCommonPageQuery<T>:IActiveRecordQuery where T : new()
    {
        private int _start;
        private int _limit;
        ...
        public SqlCommonPageQuery(string query, int start, int limit, string sort, string dir, string tableName, string primaryKey, string[][] filters, string otherWhere, params object[] otherParameters)
        {
            _start = start;
            _limit = limit;
            _sort = sort;
