...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
        ...
        if (!this.drawLeftIcon || this.hideNavIcons) {if(this.addIcon)this.addIcon.dom.style.display='none'; }
        if (!this.drawRightIcon || this.hideNavIcons) {if(this.removeIcon)this.removeIcon.dom.style.display='none'; }
